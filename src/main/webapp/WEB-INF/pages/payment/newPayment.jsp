                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Payment Form</strong> new
                                    </div>
                                        ...
                                        <form action="addPayment" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input readonly type="text" style="width: 400px; " id="text-input4"
                                                           value="${payment.reservation.id_reservation}"
                                                           name="reservationId" placeholder="reservation"
                                                           class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input9"
                                                           class=" form-control-label"><strong>Invoice
                                                        number</strong></label>
                                                    <input readonly type="text" style="width: 400px;" id="text-input9"
                                                           value="${payment.id_payment}"
                                                           name="paymentId" placeholder="Payment Id"
                                                           class="form-control">
                                                    <small class="form-text text-muted">Please enter payment Id</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1"
                                                           class=" form-control-label"><strong>Added
                                                        date</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-input1"
                                                           name="addedDate" placeholder="added date"
                                                           class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1"
                                                           class=" form-control-label"><strong>Payment
                                                        method</strong></label>
                                                    <select name="paymentMethod" style="width: 400px;" id="select1"
                                                            class="form-control">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" id="paymentSubmitId">
                                                  Save
                                              </button>
                                        </form>
                                    </div>
