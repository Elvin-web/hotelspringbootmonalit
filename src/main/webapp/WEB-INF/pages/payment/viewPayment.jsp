                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="getPaymentList" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Reservation</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">${payment.reservation.id_reservation}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label"><strong>Invoice
                                                        number</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input" class="form-text text-muted">${payment.id_payment}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1" class=" form-control-label"><strong>Added
                                                        date</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${payment.added_date}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1" class=" form-control-label"><strong>Payment
                                                        method</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="select1"
                                                         class="form-text text-muted">${payment.payType.pay_type}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input3"
                                                         class="form-text text-muted">${payment.amount}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input4" class=" form-control-label"><strong>Create
                                                        on</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input4" class="form-text text-muted">${payment.data_date}</big>
                                                </div>
                                            </div>
