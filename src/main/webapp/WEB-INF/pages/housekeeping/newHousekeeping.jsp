                                ...
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="*/addHousekeeping" method="post"
                                            ...
                                            <input type="hidden" name="id" value="${id_room}" id="roomId">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select"
                                                           class=" form-control-label"><strong>Housekeeping Status</strong></label>
                                                    <select name="housekeepingStatus" style="width: 400px;" id="select"
                                                            class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input"
                                                           name="remark" placeholder="Remark" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <select name="staff" style="width: 400px;" id="select1"
                                                            class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input4"
                                                           name="cleanDate" placeholder="Date"
                                                           class="form-control">
                                                    <small class="form-text text-muted">Please enter date</small>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-primary btn-sm" id="housekeepingSubmitId"
                                                    > Save
                                            </button>
                                        </form>
                                    </div>
