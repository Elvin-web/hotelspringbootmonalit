                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="/*/updateHousekeeping" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <input type="hidden" name="id" value="${housekeeping.room.id_room}" id="roomId">
                                           ...
                                           <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;"  readonly="readonly" id="text-input2U" value="${housekeeping.room.number}"
                                                           name="text-input2U" placeholder="Room" class="form-control">
                                                    <small class="form-text text-muted">Please enter Room</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectU"
                                                           class=" form-control-label"><strong>Housekeeping Status</strong></label>
                                                    <select name="selectU" style="width: 400px;" id="selectU"
                                                        ...
                                                        <c:forEach items="${housekeepingStatusList}" var="hsl">
                                                            <option value="${hsl.id_housekeeping_status}">${hsl.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-inputU"
                                                           class=" form-control-label"><strong>Remark</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${housekeeping.remark}"
                                                           name="text-inputU" placeholder="Remark" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1U"
                                                           class=" form-control-label"><strong>Assigned to</strong></label>
                                                    <select name="select1U" style="width: 400px;" id="select1U"
                                                        ...
                                                        <c:forEach items="${staffList}" var="sl">
                                                            <option value="${sl.id_staff}">${sl.first_name} ${sl.last_name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input4U" value="${housekeeping.clean_date}"
                                                           name="text-input4U" placeholder="Date"
                                                           class="form-control">
                                                    <small class="form-text text-muted">Please enter date</small>
                                                </div>
                                            </div>
                                            <a href="javascript: updateHousekeeping('${housekeeping.id_housekeeping}');">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#selectU').val('${housekeeping.housekeepingStatus.id_housekeeping_status}');
        $('#select1U').val('${housekeeping.staff.id_staff}');
    });
</script>
</body>
