    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Housekeeping &nbsp;<small>List</small>
                    <div class="btn-group fa-pull-right">
                        <a href="newHousekeeping/${id_room}">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <tbody>
                            <c:forEach items="${housekeepingList}" var="hl">
                                <c:if test="${hl.active eq 1}">
                                    <tr role="row" class="odd">
                                        <td>${hl.id_housekeeping}</td>
                                        <td>${hl.room.number}</td>
                                        <td>${hl.room.floor.name}</td>
                                        <td>${hl.housekeepingStatus.name}</td>
                                        <td>${hl.staff.first_name} ${hl.staff.last_name}</td>
                                        <td>
                                            <div class="btn-group" style="float: right">
                                                <a class="btn au-btn--green"
                                                   href="viewHousekeeping/${hl.id_housekeeping}">
                                                    <i class="fas fa-eye"></i>View
                                                </a>
                                                <a class="btn btn-primary"
                                                   href="editHousekeeping/${hl.id_housekeeping}">
                                                    <i class="fas fa-pencil-alt"></i>Edit
                                                </a>
                                                <a class="btn btn-danger"
                                                   href="javascript: deleteHousekeeping('${hl.id_housekeeping}','${hl.id_housekeeping}');">
