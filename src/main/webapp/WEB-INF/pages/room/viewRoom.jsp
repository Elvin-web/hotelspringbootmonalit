                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="getRoomList" method="post"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input" class="form-text text-muted">
                                                        ${room1.floor.name}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Room
                                                        number</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">
                                                    ${room1.number}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <big id="select1" class="form-text text-muted">
                                                    ${room1.roomType.room_type}</big>

                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1" class=" form-control-label"><strong>Amenities</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">
                                                        <c:forEach
                                                                items="${room_amenitiesList}" var="d">${d.amenities.name}${","}
                                                    </c:forEach>
                                                    </big>
                                                </div>
                                            </div>
