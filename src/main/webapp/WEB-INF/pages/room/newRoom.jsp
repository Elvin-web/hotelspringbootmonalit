                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input"
                                                           class=" form-control-label"><strong>Room number</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-input"
                                                           name="text-input" placeholder="Room number" class="form-control">
