                                    ...
                                    <div class="card-body card-block">
                                        <form action="*/updateRoom" method="post"
                                                ...
                                                <div class="col col-md-3">
                                                    ...
                                                    <select name="floor" style="width: 400px;" id="selectU"
                                                        ...
                                                        <c:forEach items="${floorList}" var="fl">
                                                            <option value="${fl.id_floor}">${fl.name} ${fl.floor_number}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col col-md-3">
                                                    ...
                                                    <select name="amenities" style="width: 400px;"
                                                        ...
                                                        <c:forEach items="${amenitiesList}" var="al">
                                                                ...
                                                                <c:forEach items="${room_amenitiesList}" var="rolUsu">
                                                                    <c:if test="${rolUsu.amenities.id_amenities==al.id_amenities==(rolUsu.active==1)}">
                                                                        <c:set var="isSelected" value="true" />
                                                                    </c:if>
                                                                </c:forEach>
                                                                <c:choose>
                                                                    <c:when test="${isSelected}">
                                                                        <option value="${al.id_amenities}" selected="selected">${al.name}</option>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <option value="${al.id_amenities}">${al.name}</option>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </c:forEach>
                                                    </select>
                                          ...
                                          <!--  <button type="submit" class="btn btn-primary btn-sm">
                                            ...
                                            <a href="javascript: updateDictionary('${room1.id_room}');">
...
<script type="text/javascript">
    $(function () {
        ...
        $(function () {
            $('#select1U').val('${room1.roomType.id_room_type}');
            $('#selectU').val('${room1.floor.id_floor}');
        });
    });
</script>
</body>
