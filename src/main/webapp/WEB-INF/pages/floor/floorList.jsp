    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Floor &nbsp;<small>List</small>
                ...
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Floor</div>
                                    ...
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn au-btn--green"
                                               href="viewFloor/${fl.id_floor}">
                                                <i class="fas fa-eye"></i>View
                                            </a>
                                            <a class="btn btn-primary"
                                               href="editFloor/${fl.id_floor}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteFloor('${fl.id_floor}','${fl.name}');">
