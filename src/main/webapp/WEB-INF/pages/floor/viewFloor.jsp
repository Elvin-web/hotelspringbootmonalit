                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="getFloorList" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Name</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">${floor1.name}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label"><strong>Floor number</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input" class="form-text text-muted">${floor1.floorNumber}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1" class=" form-control-label"><strong>Description</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${floor1.description}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1" class=" form-control-label"><strong>Active</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="select1"
                                                         class="form-text text-muted">${floor1.action}</big>
                                                </div>
                                            </div>
                                            <a href="getFloorList">
