                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Amenities Form</strong> edit
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="updateAmenities" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <input type="hidden" name="id" value="${amenities1.id_amenities}">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="descriptionIdU"
                                                           class=" form-control-label"><strong>Description</strong></label>
                                                    <textarea name="description" id="descriptionIdU" rows="9"
                                                              placeholder="Content..."
                                                              class="form-control">${amenities1.description}</textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="file" style="width: 400px;" id="file-input"
                                                           ...
                                                           name="fileName1" placeholder="Name" class="form-control-file">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="action1U"
                                                           class=" form-control-label"><strong>Active</strong></label>
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="action1U" class="form-check-label ">
                                                                <input type="checkbox" id="action1U" name="action1" value="1"
                                                                       <c:if test="${amenities1.action==1}">checked </c:if>
