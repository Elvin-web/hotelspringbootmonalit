...
<head>
    <!-- Main CSS-->
    <link href="./resources/newLayout/css/theme.css" rel="stylesheet" media="all">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <c:forEach items="${amenitiesList}" var="al">
                                <c:if test="${al.active eq 1}">
                                <tr role="row" class="odd">
                                    <td>${al.id_amenities}</td>
                                    <td>${al.name}</td>
                                    <td><span class="status--process">${al.action}</span></td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn au-btn--green"
                                               href="viewAmenities/${al.id_amenities}">
                                                <i class="fas fa-eye"></i>View
                                            </a>
                                            <a class="btn btn-primary"
                                               href="editAmenities/${al.id_amenities}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteAmenities('${al.id_amenities}','${al.name}');">
