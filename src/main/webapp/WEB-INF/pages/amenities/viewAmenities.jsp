                                    ...
                                    <div class="card-body card-block">
                                        <form action="addAmenities" method="post"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <big id="select" class="form-text text-muted">${amenities1.name}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input"
                                                         class="form-text text-muted">${amenities1.description}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${amenities1.action}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <a id="select1" class="item-gallery-sidebar wrap-pic-w" href="/hotelMonalit/${filePath2}"
                                                       data-lightbox="gallery-footer">
                                                        <img src="/hotelMonalit/${filePath2}" alt="GALLERY">
                                                    </a>
                                                </div>
                                            </div>
                                                <a href="getAmenitiesList">
