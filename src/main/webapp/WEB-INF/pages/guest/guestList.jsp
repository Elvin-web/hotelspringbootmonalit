    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Guest &nbsp;<small>List</small>
                    ...
                    <div class="col-xl-4 col-sm-6 mb-3" >
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">${reservationAcount} Bookings</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="#">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                    ...
                    <div class="col-xl-4 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">${ToWeekIncomeCount} One Week Income</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="#">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                ...
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Guest</div>
                                    ...
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn btn-primary"
                                               href="editGuest/${gl.id_guest}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteGuest('${gl.id_guest}','${gl.name}');">
                                                <i class="fas fa-trash"></i>Delete
                                            </a>
                                            <a class="btn au-btn--blue"
                                               href="viewGuest/${gl.id_guest}">
                                                <i class="fas fa-eye"></i>View
                                            </a>
                                            <a class="btn au-btn--green"
                                               href="paymentGuest/${gl.id_guest}">
