                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>View Guest</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="getGuestList" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label"><strong>Name</strong></label>&nbsp;
                                                </div>
                                                <big id="select" class="form-text text-muted">${guest1.name} ${guest1.surname}</big>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label"><strong>Gender</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input" class="form-text text-muted">${guest1.gender}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1" class=" form-control-label"><strong>DOB</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input1"
                                                         class="form-text text-muted">${guest1.dob}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1" class=" form-control-label"><strong>Email</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="select1"
                                                         class="form-text text-muted">${guest1.email}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input3"
                                                         class="form-text text-muted">${guest1.phone}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input4" class=" form-control-label"><strong>Address</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input4" class="form-text text-muted">${guest1.city.country.name} ${guest1.city.name}</big>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input5" class=" form-control-label"><strong>ID</strong></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <big id="text-input5" class="form-text text-muted">${guest1.passport_number}</big>
                                                </div>
                                            </div>
