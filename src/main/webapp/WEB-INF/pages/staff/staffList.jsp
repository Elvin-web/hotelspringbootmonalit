    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Employee &nbsp;<small>List</small>
                ...
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Employee</div>
                            ...
                            <c:forEach items="${staffList}" var="sl">
                                <c:if test="${sl.active eq 1}">
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${sl.gender}</td>
                                        <td>${sl.address}</td>
                                        <td>${sl.position.position_value}</td>
                                        <td>
                                            <div class="btn-group" style="float: right">
                                                <a class="btn btn-secondary"
                                                   href="viewStaff/${sl.id_staff}">
                                                    <i class="fas fa-eye"></i>View
                                                </a>
                                                <a class="btn btn-primary"
                                                   href="editStaff/${sl.id_staff}">
                                                    <i class="fas fa-pencil-alt"></i>Edit
                                                </a>
                                                <a class="btn btn-danger"
                                                   href="javascript: deleteStaff('${sl.id_staff}','${sl.first_name}');">
