                                        ...
                                        <form action="*/updateServices" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${services1.name}"
                                                           name="text-inputU" placeholder="Title" class="form-control">
                                                ...
                                                <div class="col col-md-3">
                                                    ...
                                                    <select name="selectU" style="width: 400px;" id="selectU"
                                                        ...
                                                        <c:forEach items="${priceTypeList}" var="ptl">
                                                            <option value="${ptl.id_price_type}">${ptl.price_type}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input1U" value="${services1.amount}"
                                                           name="text-input1U" placeholder="Price" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <textarea name="textarea-input" style="width: 400px;" id="textarea-inputU" rows="9"
                                                              placeholder="Content..." class="form-control">${services1.description}</textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1U" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1U" name="checkbox1U"<c:if test="${services1.action==1}">checked </c:if>  value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="javascript: updateServices('${services1.id_services}');">
...
<script type="text/javascript">
    ...
    $(function () {
        $('#selectU').val('${services1.priceType.id_price_type}');
    })
</script>
