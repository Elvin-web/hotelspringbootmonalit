    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Services &nbsp;<small>List</small>
                ...
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Services</div>
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <tbody>
                            <c:forEach items="${servicesList}" var="srl">
                                <c:if test="${srl.active eq 1}">
                                <tr role="row" class="odd">
                                    <td>${srl.id_services}</td>
                                    <td>${srl.name}</td>
                                    <td>${srl.action}</td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn btn-primary"
                                               href="editServices/${srl.id_services}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteServices('${srl.id_services}','${srl.name}');">
