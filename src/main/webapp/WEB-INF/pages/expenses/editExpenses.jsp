                                ...
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="updateExpenses" method="post"
                                            ...
                                            <input type="hidden" name="id" value="${expenses1.id_expenses}">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${expenses1.date_insert}"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" style="width: 400px;" id="text-input1U" value="${expenses1.name}"
                                                           name="name"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" style="width: 400px;" id="text-input2U" value="${expenses1.amount}"
                                                           name="amount"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" style="width: 400px;" id="file-inputU" name="fileName1" value="${expenses1.document}"
...
<script type="text/javascript">
    $(function () {
        ...
        $(function () {
            $('#selectU').val('${expenses1.expensesType.id_expenses_type}');
        });
    });
</script>
</body>
