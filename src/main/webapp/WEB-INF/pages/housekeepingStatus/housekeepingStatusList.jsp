    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Housekeeping status &nbsp;<small>List</small>
                    <div class="btn-group fa-pull-right">
                        <a href="newHousekeepingStatus">
                            <button class="btn btn-success"><strong>+</strong> Add</button>
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Housekeeping status</div>
                        ...
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <c:forEach items="${housekeepingStatusList}" var="hl">
                                <tr role="row" class="odd">
                                    <td>${hl.id_housekeeping_status}</td>
                                    <td>${hl.name}</td>
                                    <td>${hl.action}</td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn btn-primary"
                                               href="editHousekeepingStatus/${hl.id_housekeeping_status}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteHousekeepingStatus('${hl.id_housekeeping_status}','${hl.name}');">
