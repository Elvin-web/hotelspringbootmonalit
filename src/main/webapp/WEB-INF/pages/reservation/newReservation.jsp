                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Reservation Form</strong> new
                                    </div>
                                        ...
                                        <form action="addReservation" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-input"
                                                           name="text-input" placeholder="Adults" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" style="width: 400px;" id="text-input1"
                                                           name="text-input1" placeholder="Kids" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input2"
                                                           name="text-input2" placeholder="Check in" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input3"
                                                           name="text-input3" placeholder="Check out" class="form-control">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1" name="extraBed" value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    $(function () {
        $('#text-input2').datepicker({
            changeMonth: true,
            changeYear: true

        });
        $('#text-input3').datepicker({
            changeMonth: true,
            changeYear: true
