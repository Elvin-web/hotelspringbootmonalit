                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Reservation Form</strong> edit
                                    </div>
                                        ...
                                        <form action="updateReservation" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectU"
                                                           class=" form-control-label"><strong>Guest</strong></label>
                                                    <select name="selectU" style="width: 400px;" id="selectU"
                                                            class="form-control">
                                                        <option value="0">Please select Guest</option>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select1U"
                                                           class=" form-control-label"><strong>Room</strong></label>
                                                    <select name="select1U" style="width: 400px;" id="select1U"
                                                            class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-inputU"
                                                           class=" form-control-label"><strong>Adults</strong></label>
                                                    <input type="number" style="width: 400px;" id="text-inputU" value="${reservation1.adults}"
                                                           name="text-inputU" placeholder="Adults" class="form-control">
                                                    <small class="form-text text-muted">Please enter adults</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1U"
                                                           class=" form-control-label"><strong>Kids</strong></label>
                                                    <input type="number" style="width: 400px;" id="text-input1U" value="${reservation1.children}"
                                                           name="text-input1U" placeholder="Kids" class="form-control">
                                                    <small class="form-text text-muted">Please enter kids</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input2U"
                                                           class=" form-control-label"><strong>Check in</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-input2U" value="${reservation1.check_in}"
                                                           name="text-input2U" placeholder="Check in" class="form-control">
                                                    <small class="form-text text-muted">Please enter check in</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input3U"
                                                           class=" form-control-label"><strong>Check out</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-input3U" value="${reservation1.check_out}"
                                                           name="text-input3U" placeholder="Check out" class="form-control">
                                                    <small class="form-text text-muted">Please enter check out</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1U" class="form-check-label ">
                                                                <input type="checkbox" id="checkbox1U"  name="extraBed" <c:if test="${reservation1.extra_bed==1}">checked </c:if> name="checkbox1" value="1" class="form-check-input">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="javascript: updateReservation('${reservation1.id_reservation}');">
...
<script type="text/javascript">
    $(function () {
        $('#text-input2U').datepicker({
            changeMonth: true,
            changeYear: true
        });
        $('#text-input3U').datepicker({
            changeMonth: true,
            changeYear: true
        });
        $('#selectU').val('${reservation1.guest.id_guest}');
        $('#select1U').val('${reservation1.roomType.id_room_type}');
    });
</script>
</body>
