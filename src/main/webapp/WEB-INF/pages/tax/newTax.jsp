                                        ...
                                        <form action="addTax" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input1"
                                                           name="text-input1" placeholder="Code" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="number" step="0.1" style="width: 400px;" id="text-input2"
                                                           name="text-input2" placeholder="Tax Rate" class="form-control">
