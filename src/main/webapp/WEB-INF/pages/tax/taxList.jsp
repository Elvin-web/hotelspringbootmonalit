    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Tax &nbsp;<small>List</small>
                ...
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Tax</div>
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <c:forEach items="${taxList}" var="tl">
                                <c:if test="${tl.active eq 1}">
                                <tr role="row" class="odd">
                                    <td>${tl.id_tax}</td>
                                    <td>${tl.name}</td>
                                    <td>${tl.code}</td>
                                    <td>${tl.rate}</td>
                                    <td>${tl.taxType.type}</td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn btn-primary"
                                               href="editTax/${tl.id_tax}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteTax('${tl.id_tax}','${tl.name}');">
