    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Position &nbsp;<small>List</small>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <c:forEach items="${positionList}" var="pl">
                                <c:if test="${pl.active eq 1}">
                                <tr role="row" class="odd">
                                    <td>${pl.id_position}</td>
                                    <td>${pl.position_value}</td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn btn-primary"
                                               href="editPosition/${pl.id_position}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deletePosition('${pl.id_position}','${pl.position_value}');">
