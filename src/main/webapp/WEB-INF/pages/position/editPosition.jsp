                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Position Form</strong> edit
                                    </div>
                                        ...
                                        <form action="*/updatePosition" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${position1.position_value}"
                                                           name="text-input" placeholder="Name" class="form-control">
                                                    <small class="form-text text-muted">Please enter name</small>
                                                </div>
                                            </div>

                                            <a href="javascript: updatePosition('${position1.id_position}');">
                                                <button type="button" class="btn btn-primary btn-sm" id="positionSubmitIdU">
                                                    Update
                                                </button>
                                            </a>
                                        </form>
