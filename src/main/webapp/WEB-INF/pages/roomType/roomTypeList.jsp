    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Room types &nbsp;<small>List</small>
                ...
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Room types</div>
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <c:forEach items="${roomTypeList}" var="rtl">
                                <c:if test="${rtl.active eq 1}">
                                <tr role="row" class="odd">
                                    <td>${rtl.id_room_type}</td>
                                    <td>${rtl.room_type}</td>
                                    <td>${rtl.short_code}</td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn au-btn--green"
                                               href="viewRoomType/${rtl.id_room_type}">
                                                <i class="fas fa-eye"></i>View
                                            </a>
                                            <a class="btn btn-primary"
                                               href="editRoomType/${rtl.id_room_type}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteRoomType('${rtl.id_room_type}','${rtl.room_type}');">
