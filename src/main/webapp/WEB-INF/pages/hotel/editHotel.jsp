                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Hotel Form</strong> edit
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="updateHotel" method="post"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <input type="hidden" name="id" value="${hotel1.id_hotel}">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-input2U"
                                                           value="${hotel1.phone}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="email" style="width: 400px;" id="email-inputU"
                                                           value="${hotel1.email}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectU"
                                                           class=" form-control-label"><strong>Star</strong></label>
                                                    <select name="star" style="width: 400px;" id="selectU"
                                                            class="form-control">
                                                        <option value="0">Please select Star</option>
                                                        <c:forEach items="${starList}" var="sl">
                                                        <option value="${sl.id_star}">${sl.star}</option>
                                                    </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
...
<script src="../resources/js/hotel.js"></script>

<script type="text/javascript">
    $(function () {
        $('#selectU').val('${hotel1.star.id_star}');
    })
</script>
