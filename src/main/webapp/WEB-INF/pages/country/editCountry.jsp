                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Country Form</strong> edit
                                    </div>
                                        ...
                                        <form action="*/updateCountry" method="post"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    ...
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${country1.name}"
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input1U"
                                                           class=" form-control-label"><strong>Sortname</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-input1U" value="${country1.sort_name}"
                                                           name="text-input1U" placeholder="Sortname" class="form-control">
                                                    <small class="form-text text-muted">Please enter sortname</small>
                                                </div>
                                            </div>


                                            <a href="javascript: updateCountry('${country1.id_country}');">
