    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="border: none">
                <div class="card-header">Expenses Category &nbsp;<small>List</small>
                    <div class="btn-group fa-pull-right">
                        <a href="newExpensesType">
                            <button class="btn btn-success"><strong>+</strong> Add</button>
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div style="margin-bottom: 20px;">Expenses Category</div>
                    <div class="table-responsive">
                        <table class="table table-borderless" id="dataTable" style="width: 100%;" cellspacing="0">
                            ...
                            <c:forEach items="${expensesTypeList}" var="ecl" >
                                <c:if test="${ecl.active eq 1}">
                                <tr role="row" class="odd">
                                    <td>${ecl.id_expenses_type}</td>
                                    <td>${ecl.expenses_type}</td>
                                    <td>
                                        <div class="btn-group" style="float: right">
                                            <a class="btn btn-primary"
                                               href="editExpensesType/${ecl.id_expenses_type}">
                                                <i class="fas fa-pencil-alt"></i>Edit
                                            </a>
                                            <a class="btn btn-danger"
                                               href="javascript: deleteExpensesCategory('${ecl.id_expenses_type}','${ecl.expenses_type}');">
...
<script src="./resources/js/expensesType.js"></script>
</body>
