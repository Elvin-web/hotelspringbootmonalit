                            ...
                            <div class="col-lg-12">
                                <div class="card" style="border: none">
                                    <div class="card-header">
                                        <strong>Expenses Type Form</strong> edit
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="updateExpensesType" method="POST"
                                              enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-inputU"
                                                           class=" form-control-label"><strong>Name</strong></label>
                                                    <input type="text" style="width: 400px;" id="text-inputU" value="${expensesType1.expenses_type}"
                                                           name="text-input" placeholder="Name" class="form-control">
                                                    <small class="form-text text-muted">Please enter name</small>
                                                </div>
                                            </div>
                                            <a href="javascript: updateExpensesCategory('${expensesType1.id_expenses_type}');">
